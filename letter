    ...
    <style>
        ...
        * {
        ...
        .heart-target {
            ...
            font-size: 2.5rem;
            color: #d62828;
            /* Slightly darker to blend but identifiable if looked for */
            cursor: pointer;
        ...
        /* Random positions for hearts (will be set by JS mostly, but examples here) */
...
<body>
    ...
    <div id="game-stage">
        <div class="instructions">
            <h1>Find My Heart</h1>
            <p>Hi love, I've hidden 3 hearts inside these gifts and surprises.<br>Click them to find where my heart lies!</p>
    ...
    <div id="letter-view">
        <div class="love-letter">
            ...
            <p>Just like you found these hidden hearts, you've found the deepest parts of my soul. Every moment with you is a surprise I cherish, a gift I never want to stop opening.</p>
            <p>Out of all the things I could ever wish for, having you in my life is already more than enough. You are my safe place, my happiness, and my favorite person all in one. I'm so proud of the person you're becoming. Even if I didn't witness everything, I still see how much you've grown, how strong you are, and how you keep trying no matter what. You may not always notice it, but you're doing so well, baby.</p>
            <p>I hope in this new chapter of your life, you continue to shine and show the world what you're truly capable of. I'll always be here supporting you in all your dreams. I'll stand by you no matter what, and I want to see you achieve everything you've shared with me. I hope that when the time comes that you reach all your goals, I'm still the one beside you, celebrating your success.</p>
            <p>Please never forget how special you are, how loved you are, and how much you matter—not just to me, but to this world. I'll always be here for you, my love, through everything.</p>
            <p>I love you more than words can explain baby.</p>
            <p style="text-align: right;">-sysy</p>
        </div>
    </div>

    <style>
        /* Additional Styles for Hiding Spots */
        .hiding-spots-container {
            display: flex;
            flex-wrap: wrap;
            justify-content: center;
        ...
        .hiding-spot.shaking {
            ...
            color: #ccc;
            /* Fade out slightly to show checked */
            cursor: default;
        }
        ...
        /* Adjust game stage layout for grid */
        #game-stage {
            display: flex;
